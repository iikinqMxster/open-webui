...
USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ACCESS = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ACCESS', 'False').lower() == 'true'
)
...
USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_SHARING = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_SHARING', 'False').lower() == 'true'
)

USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_PUBLIC_SHARING = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_PUBLIC_SHARING', 'False').lower() == 'true'
)
...
DEFAULT_USER_PERMISSIONS = {
    'workspace': {
        ...
        'subagents': USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ACCESS,
    ...
    'sharing': {
        ...
        'subagents': USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_SHARING,
        'public_subagents': USER_PERMISSIONS_WORKSPACE_SUBAGENTS_ALLOW_PUBLIC_SHARING,
